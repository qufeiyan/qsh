...
#define DEFINE_QSH_CMD(name, cmd, desc)                                             \
                ...
                QSH_USED const struct qsh_cmd __qsh_##cmd QSH_SECTION(".qsh.tab")=  \
                {                                                                   \
                    __qsh_##cmd##_name,                                             \
                    __qsh_##cmd##_desc,                                             \
                    (cmd_t )&cmd                                                    \
...
struct qsh{
    ...
    char line[MAX_COMMAND_SIZE + 1];    /**< commnad buffer. */
    ...
    struct{
        ...
        struct qsh_cmd *history[MAX_HISTORY_SIZE]; /**< store the historical commands. */ 
        #else
        ...
        unsigned int up_peak : 1;    
        unsigned int down_valley :1;
        unsigned int full: 1;
    };
#endif
